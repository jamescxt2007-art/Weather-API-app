...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "ENTER_YOUR_API_KEY_HERE"  #enter your own api key from OpenWeather
    ...
    def display_weather(self, data):
        ...
        temperature_c = temperature_k - 273.15  #convert to celcius
    ...
    def get_weather_emoji(self, weather_id):  #id tells the weather if its raining or sunny etc depending on the value from 0-100 or 200-300
